      ...
      <div className="max-w-[780px] mx-auto px-6 py-20">
        ...
        <div className="prose prose-slate max-w-none space-y-10 text-[0.95rem] text-navy-mid leading-[1.85]">
          ...
          <section>
            ...
            <p>Our products contain botanical extracts and supplement ingredients including L-Theanine, Rhodiola Rosea, L-Tyrosine, and Affron® Saffron Extract. Individuals may have unknown sensitivities or allergies to one or more of these ingredients. Potential adverse effects may include, but are not limited to, oral irritation or sensitivity at the site of use, allergic reaction (including rash, hives, swelling, or difficulty breathing), nausea, headache, or interactions with prescription medications. <strong>DISCONTINUE USE IMMEDIATELY</strong> and seek medical attention if you experience any adverse reaction.</p>
