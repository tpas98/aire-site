      ...
      <div className="relative z-10 max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <FadeUp>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <a href={buyUrl()} className="btn-primary inline-block bg-white text-navy px-8 py-4 rounded-full text-[0.8rem] font-semibold tracking-[0.08em] uppercase text-center">
          ...
          <p className="text-[0.65rem] text-white/25 leading-relaxed max-w-[420px]">
