...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-hero-gradient">
      ...
      <div className="relative z-10 flex flex-col md:grid md:grid-cols-2 items-center gap-8 px-6 md:px-20 pt-28 md:pt-32 pb-20 md:pb-24 max-w-[1400px] mx-auto">
        ...
        <motion.div className="flex justify-center items-center w-full" variants={fadeUp} initial="hidden" animate="visible" custom={0.2}>
          <motion.div {...floatAnim}>
            <Image src="/images/three-cans-new.png" alt="Aire Flow Pouches 3-Pack" width={720} height={720}
              className="w-full max-w-[256px] md:max-w-[544px] object-contain"
              priority />
          </motion.div>
        </motion.div>
      </div>
